...
export default function AddTask({ boardId, userId, close, allCols }) {
    ...
    const addTask = (e) => {
        ...
        Inertia.post(`/boards/${boardId}/tasks`, { title, priority, description, column }) // Use Inertia to add a task
        close()
    }
        ...
        <div className='px-3 py-2 md:px-12 text-sm md:text-base'>
            <form onSubmit={addTask} autoComplete='off'>
                ...
                <div className="my-8">
                    ...
                    <textarea name="description" className='border border-gray-300 w-full px-4 py-3 outline-none h-32' defaultValue={description} onChange={(e) => setDescription(e.target.value)} />
                </div>
